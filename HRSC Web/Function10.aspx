<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Function10.aspx.cs" Inherits="Function10" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">

    <h4>Select Sales Rep to Display Products Information which are assigned to him/her.</h4>
    <div id="f1DropDown">
