<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Function1.aspx.cs" Inherits="Function1" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">

    <h4>Find Details about a Customer Using Customer Number Or Customer Name.</h4>
    <div id="f1DropDown">
